        ...
        <>
            <div>
                <div className="flex justify-center gap-4 items-center mt-10">
                    <button className="btn btn-outline btn-primary btn-square" onClick={() => { scroll("left") }}>
                    ...
                    <button className="btn btn-outline btn-primary btn-square" onClick={() => { scroll("right") }}>
