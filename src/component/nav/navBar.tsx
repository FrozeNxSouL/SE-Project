...
export default function NavBar() {
  ...
  // }
  return (
    <div className="flex flex-col justify-center items-start bg-base-100 sticky top-0 z-20">
      ...
      <div className="navbar bg-base-100">
        <div className="navbar bg-base-100 w-1/3"></div>
        <div className="flex flex-col justify-center w-1/3 h-fit bg-base-100">
          <div className="my-1">
            ...
            <Link href="/sell" className=" btn btn-ghost text-base">
              <span className="material-icons">attach_money</span>Sell
            </Link>
            <Link href="/" className=" btn btn-ghost text-base">
              <span className="material-icons">local_shipping</span>Items Status
            </Link>
          </div>
        </div>
        <div className="flex flex-row w-1/3 h-fit bg-base-100 justify-end">
