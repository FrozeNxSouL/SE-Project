...
export default function Footer() {
    return (
        <footer className="footer items-center p-4 bg-accent text-base-100 min-h-32">
            ...
            <aside className="items-center grid-flow-col">
                <div className="flex flex-col">
                    <h4 className="font-bold">Framework & Development Tools</h4>
                    <p>Next.js Tailwind.css Prisma MongoDB</p>
                </div>
            </aside>
            <aside className="items-center grid-flow-col">
                <div className="flex flex-col">
