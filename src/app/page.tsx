...
import { getAuctionProduct } from '@/api/auth/home/productFetch'
import { promises } from 'dns'
import { itemJson } from '@/api/auth/home/type';
function HomePage() {
  const cunny = async (): Promise<itemJson[] | null> => {
    try {
      const res = await getAuctionProduct();
      if (res.ok) {
  ...
  return (
    <div className='flex justify-center flex-col w-full bg-black px-32'>
      ...
      <div className="carousel w-full bg-slate-400">
        <div id="slide1" className="carousel-item relative w-full bg-slate-700">
        ...
        <div id="slide2" className="carousel-item relative w-full bg-slate-700">
          <div className='flex flex-row justify-evenly my-6 w-full'>
            <img className='flex size-32' src="https://scontent.fbkk6-1.fna.fbcdn.net/v/t39.30808-6/428615837_944079027072799_675545480892552765_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=dd5e9f&_nc_eui2=AeGSH6AltvlTali6lGpxPxQVJwJZdwJOM2InAll3Ak4zYh4Fas1ROKJT_nfUolU1CvEH5as5njdHa9UeM1m-scfT&_nc_ohc=Rv0tpJYVLusAX-qt2p1&_nc_ht=scontent.fbkk6-1.fna&oh=00_AfCrIdsUiXe5PtEaTv6fPH30GykqCSCMfBGa-00tBdp9jg&oe=65D6CB63" />
            <div className='flex flex-col'>
              <p className='flex text-2xl'>ไอเหี้ยนี่แม่งเกย์</p>
        ...
        <div id="slide3" className="carousel-item relative w-full py-10 bg-slate-700">
        ...
        <div id="slide4" className="carousel-item relative w-full py-10 bg-slate-700">
      ...
      <div className="carousel w-full bg-">
        ...
        <div className='flex flex-col w-full'>
          ...
          <div className='flex flex-row justify-evenly my-6 w-2/5'>
            ...
            <div className='flex flex-col'>
              ...
              <p>due time : 15.00</p>
              <p className='flex text-3xl'>1000 Baht</p>
              <button className="btn btn-primary" onClick={getAuctionProduct}>Primary</button>
      ...
      <div>
        ...
        <div className='flex flex-wrap justify-between'>
          {/* {cunny.map((item:itemJson,index:number) => (
            <div className="card w-96 bg-base-100 shadow-xl basis-72" key={item.id}>
